...
Originally BTCPay did use noseedbackup, so you couldn’t backup your LN wallet or get your recovery seed. This is because in Lightning Network there’s still no solution for backing up funds in channels, just in your on-chain wallet.
...
If you migrate from an older version to `v1.0.3.138` [this post on how to do the migration](https://blog.btcpayserver.org/btcpay-lnd-migration) might be helpful.
